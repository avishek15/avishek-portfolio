...
const AboutPage = () => {
  ...
  return (
    ...
    >
      {/* CONTAINER */}
      <div className="h-full overflow-y-scroll md:flex" ref={containerRef}>
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 w-full md:w-2/3 xl:w-1/2">
          {/* BIOGRAPHY CONTAINER */}
        ...
        {/* SVG CONTAINER */}
        <div className="hidden md:flex md:w-1/3 xl:w-1/2 sticky top-0">
